...
INPUT_FILE_PATH = "courtdecision_intent.csv"

INPUT_TEXT_COLUMN = 'ementa_text'
INPUT_LABEL_COLUMN = 'decision_label'

FINAL_TEXT_COLUMN = 'sentence'
FINAL_LABEL_COLUMN = 'label'

OUTPUT_BASE_DIR = "data"
DATASET_NAME = "CourtDecisionCorpus" 
NUM_FOLDS = 5
RANDOM_SEED = 42

LABEL_MAP = {
    "yes": "recurso provido",
    "no": "recurso não provido",
    "partial": "recurso parcialmente provido"
}
...
def load_data_from_csv(file_path):
    """
    Carrega, extrai, limpa e traduz os dados do arquivo CSV.
    """
    ...
    if unmapped_mask.any():
        ...
        print(f"ATENÇÃO: As seguintes labels não foram encontradas no mapa de tradução:")
